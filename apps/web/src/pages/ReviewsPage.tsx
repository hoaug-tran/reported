...
export const ReviewsPage: React.FC = () => {
  ...
  const hasActiveFilters =
    search || typeFilter !== "ALL" || statusFilter !== "ALL" || waitingOnly;
      ...
      <Box sx={{ mb: 2.5 }}>
        <Box sx={{ mb: 1.5 }}>
          ...
          <Typography variant="body2" sx={{ color: tokens.textSecondary }}>
            Thẩm định kiến trúc, đánh giá PR, kiểm tra schema cơ sở dữ liệu và
            đánh giá bảo mật
          </Typography>
        </Box>
      ...
      >
        ...
        <FormControl size="small" sx={{ minWidth: 140 }}>
          ...
          >
            ...
            <MenuItem value={ReviewStatus.COMPLETED}>
              {t("statusCompleted")}
            </MenuItem>
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ minWidth: 0, flex: 1 }}>
                    ...
                    >
                      <Chip
                        label={
                          rev.reviewType === ReviewType.PR
                            ? "PR"
                            : rev.reviewType === ReviewType.CODE
                              ? "Code"
                              : rev.reviewType
                        }
                        sx={{
                ...
                >
                  {rev.reviewers && rev.reviewers.length > 0 && (
                    ...
                    >
                      {rev.reviewers.map(
                        (r: ReviewerAssignmentDto, i: number) => (
                          <Box
                            key={r.user.id}
                            sx={{
                              ml: i === 0 ? 0 : -0.8,
                              zIndex: rev.reviewers.length - i,
                            }}
                          >

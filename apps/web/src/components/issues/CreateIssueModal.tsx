      ...
      >
        ...
        {issueType === IssueType.BUG && useTemplate ? (
          <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
            ...
            <TextField
              ...
              fullWidth
              label={
                isVi ? "Điều kiện tiên quyết (Precondition)" : "Preconditions"
              }
            ...
            >
              <TextField
                ...
                rows={2}
                label={
                  isVi ? "Kết quả thực tế (Actual Result)" : "Actual Result"
                }
                value={actualResult}
              ...
              <FormControl size="small" fullWidth>
                ...
                >
                  <MenuItem value={BugFrequency.ALWAYS}>
                    {isVi ? "Luôn luôn (100%)" : "Every time (100%)"}
                  </MenuItem>
                  <MenuItem value={BugFrequency.OFTEN}>
                    {isVi ? "Thường xuyên (~50%)" : "Often (~50%)"}
                  </MenuItem>
                  <MenuItem value={BugFrequency.SOMETIMES}>
                    {isVi ? "Thỉnh thoảng" : "Intermittent"}
                  </MenuItem>
                  <MenuItem value={BugFrequency.RARE}>
                    {isVi ? "Hiếm khi" : "Rarely"}
                  </MenuItem>
                </Select>
              </FormControl>
            ...
            <Box>
              ...
              >
                {isVi
                  ? "LOG / STACK TRACE / PAYLOAD JSON"
                  : "EVIDENCE / LOGS / JSON PAYLOAD"}
              </Typography>
              <MarkdownEditor
                value={evidenceJson}
                ...
                placeholder={
                  isVi
                    ? "Dán stack trace, payload JSON hoặc terminal logs tại đây..."
                    : "Paste stack trace, JSON error payload, or terminal logs here..."
                }
                minRows={3}
              />
            </Box>
          ...
          <Box>
            ...
            <MarkdownEditor
              ...
              placeholder={
                isVi
                  ? "Mô tả chi tiết tác vụ, đính kèm liên kết, code snippet hoặc phương án đề xuất..."
                  : "Describe the issue, add links, code snippets, or JSON..."
              }
              minRows={5}
            />
          </Box>
        ...
        >
          <Autocomplete
            ...
            onChange={(_, vals) =>
              setSelectedAssigneeIds(vals.map((v) => v.id))
            }
            renderInput={(params) => (
              <TextField
                {...params}

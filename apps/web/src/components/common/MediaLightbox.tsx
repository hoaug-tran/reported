...
import { X, ZoomIn, ZoomOut, RotateCw, RotateCcw, Download } from 'lucide-react';
    ...
    <Fade in={open}>
      ...
      >
        ...
        >
          <Typography
            variant="body2"
            sx={{ color: 'rgba(255, 255, 255, 0.8)', fontWeight: 600, maxWidth: '60%' }}
            noWrap
          >
            {alt}
          </Typography>
          ...
          >
            ...
            <Typography variant="caption" sx={{ color: '#fff', fontWeight: 600, minWidth: 40, textAlign: 'center' }}>

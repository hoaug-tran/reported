...
export const ListSkeleton: React.FC<{ rows?: number }> = ({ rows = 6 }) => {
  ...
  return (
    ...
    >
      <Box sx={{ p: 2, borderBottom: `1px solid ${tokens.border}`, display: 'flex', gap: 2, alignItems: 'center' }}>
      ...
      {Array.from({ length: rows }).map((_, idx) => (
        <Box
          ...
          sx={{
            ...
            borderBottom: idx < rows - 1 ? `1px solid ${tokens.border}` : 'none',
            gap: 2
          }}
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flex: 1 }}>
            ...
            <Box sx={{ flex: 1, maxWidth: 500 }}>
              ...
              <Box sx={{ display: 'flex', gap: 1, mt: 0.5 }}>
                ...
                <Skeleton variant="rectangular" width={45} height={18} sx={{ borderRadius: 1 }} />
              </Box>
            </Box>
          </Box>
...
export const DetailSkeleton: React.FC = () => {
  ...
  return (
    <Box sx={{ ...smoothFadeSx, display: 'grid', gridTemplateColumns: { xs: '1fr', lg: '1fr 340px' }, gap: 3.5, alignItems: 'start' }}>
      <Box sx={{ minWidth: 0 }}>
        <Box sx={{ mb: 2 }}>
          <Skeleton variant="text" width="70%" height={40} sx={{ mb: 1 }} />
          <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
            <Skeleton variant="rectangular" width={80} height={26} sx={{ borderRadius: 1 }} />
        ...
        <Box sx={{ mt: 3, pt: 2 }}>
          ...
          <Skeleton variant="rectangular" width="100%" height={100} sx={{ borderRadius: '8px', mb: 2 }} />
      ...
      >
        ...
        <Box>
          ...
          <Box sx={{ display: 'flex', gap: 0.8 }}>
            ...
            <Skeleton variant="rectangular" width={65} height={22} sx={{ borderRadius: 1 }} />
          </Box>
        </Box>
      </Box>
    </Box>
...
export const DashboardSkeleton: React.FC = () => {
  ...
  return (
    <Box sx={{ ...smoothFadeSx, display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', lg: '1fr 340px' }, gap: 3, alignItems: 'start' }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <Skeleton variant="rectangular" width="100%" height={320} sx={{ borderRadius: '8px' }} />
        </Box>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
...
export const AppShellSkeleton: React.FC = () => {
  ...
  return (
    <Box sx={{ ...smoothFadeSx, display: 'flex', width: '100vw', height: '100vh', overflow: 'hidden', backgroundColor: tokens.background }}>
      <Box
        sx={{
          width: 240,
          height: '100vh',
      ...
      >
        ...
        {Array.from({ length: 7 }).map((_, idx) => (
          <Skeleton key={idx} variant="rectangular" width="100%" height={36} sx={{ borderRadius: 1 }} />
        ))}
      </Box>
        ...
        >
          <Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1.5 }}>
              ...
              <Skeleton variant="rectangular" width={48} height={20} sx={{ borderRadius: 1 }} />
            </Box>
            <Skeleton variant="text" width="90%" height={18} />
            <Skeleton variant="text" width="70%" height={18} sx={{ mt: 0.5 }} />
          </Box>
          <Box sx={{ display: 'flex', gap: 2, mt: 3, pt: 1.5, borderTop: `1px solid ${tokens.border}` }}>
...
export const RepositoryCardSkeleton: React.FC<{ count?: number }> = ({ count = 4 }) => {
  const { tokens } = useThemeContext();

  return (
    <Box sx={{ ...smoothFadeSx, display: 'flex', flexDirection: 'column', gap: 2 }}>
      {Array.from({ length: count }).map((_, idx) => (
        <Card
          key={idx}
          sx={{
        ...
        >
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
              ...
              <Skeleton variant="rectangular" width={55} height={20} sx={{ borderRadius: 1 }} />
          ...
          <Box sx={{ display: 'flex', gap: 2, mt: 2, pt: 1.5, borderTop: `1px solid ${tokens.border}` }}>
...
export const MemberTableSkeleton: React.FC<{ rows?: number }> = ({ rows = 5 }) => {
  const { tokens } = useThemeContext();
    ...
    <Box sx={{ ...smoothFadeSx, display: 'flex', flexDirection: 'column' }}>
      {Array.from({ length: rows }).map((_, idx) => (
        ...
        >
          ...
          <Skeleton variant="text" width={160} height={20} sx={{ display: { xs: 'none', sm: 'block' } }} />
          <Skeleton variant="rectangular" width={85} height={28} sx={{ borderRadius: '6px' }} />
          <Skeleton variant="text" width={90} height={18} sx={{ display: { xs: 'none', md: 'block' } }} />
          <Skeleton variant="circular" width={28} height={28} />
        </Box>
      ))}
    </Box>
...
export const ConnectedAccountsSkeleton: React.FC = () => {
  ...
  return (
    <Box sx={{ ...smoothFadeSx, display: 'flex', flexDirection: 'column', gap: 2.5, maxWidth: 640 }}>
...
export const PostFeedSkeleton: React.FC<{ count?: number }> = ({ count = 4 }) => {
  const { tokens } = useThemeContext();

  return (
    <Box sx={{ ...smoothFadeSx, display: 'flex', flexDirection: 'column', gap: 2.5 }}>
      {Array.from({ length: count }).map((_, idx) => (
        <Card
          key={idx}
          sx={{
        ...
        >
          ...
          <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', pt: 1.5, borderTop: `1px solid ${tokens.border}` }}>
            <Skeleton variant="rectangular" width={50} height={22} sx={{ borderRadius: 1 }} />
            <Skeleton variant="rectangular" width={60} height={22} sx={{ borderRadius: 1 }} />
            <Skeleton variant="rectangular" width={70} height={22} sx={{ borderRadius: 1, ml: 'auto' }} />
          </Box>
        </Card>
      ))}
    </Box>

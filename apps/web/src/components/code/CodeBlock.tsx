...
export const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  const highlightedCode = React.useMemo(() => {
    const grammar = Prism.languages[langKey] || Prism.languages.text || Prism.languages.javascript;
    try {
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
          ...
          <Tooltip title={showLineNumbers ? 'Hide line numbers' : 'Show line numbers'}>
            <IconButton
              ...
              sx={{ color: showLineNumbers ? tokens.primary : tokens.textSecondary }}
            >
              <ListOrdered size={16} />
            </IconButton>
          </Tooltip>
                  ...
                  <td
                    ...
                    dangerouslySetInnerHTML={{
                      __html: Prism.highlight(
                        line,
                        Prism.languages[langKey] || Prism.languages.text || Prism.languages.javascript,
                        langKey
                      )
                    }}
                  />

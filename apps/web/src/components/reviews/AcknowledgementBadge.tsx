...
export const AcknowledgementBadge: React.FC<AcknowledgementBadgeProps> = ({
  ...
  const currentStatus = myAssignment?.acknowledgementStatus as
    AcknowledgementStatus | undefined;
    ...
    >
      ...
      >
        <Box>
          ...
          <Typography
            variant="caption"
            sx={{ color: tokens.textSecondary, fontSize: "0.74rem" }}
          >
            {isVi
      ...
      {reviewers.length > 0 && (
        ...
        >
          {reviewers.map((r) => {
            const statusKey =
              (r.acknowledgementStatus as AcknowledgementStatus) || null;

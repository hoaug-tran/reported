...
import { UserRole, WorkspaceRole, ProjectRole } from "@reported/contracts";
  ...
  try {
    ...
    const [workspace] = await db
      ...
      .values({
        ...
        slug: "engwithme",
        description:
          "Engineering collaboration workspace for core platform, web apps, and infrastructure.",
    ...
    const [projBe, projFe, projInfra] = await db
      .insert(projects)
      .values([
        {
          workspaceId: workspace.id,
        ...
        },
        {
          ...
          slug: "frontend",
          description:
            "Single page application, design system, and client tooling.",
        },
        {
          workspaceId: workspace.id,
          name: "Infrastructure",
          ...
          slug: "infra",
          description:
            "Kubernetes operators, Terraform modules, and CI/CD pipelines.",
        },
      ])
      .returning();
    ...
    await db.insert(labels).values([
      ...
      },
      {
        name: "security",
        color: "#e11d48",
        description: "Security advisory or vulnerability",
      },
      {
        name: "frontend",
        color: "#3b82f6",
        description: "UI, components, and client logic",
      },
      {
        name: "backend",
        color: "#10b981",
        description: "API, database, and background workers",
      },
      {
        name: "infrastructure",
        color: "#8b5cf6",
        description: "Docker, K8s, and cloud architecture",
      },
    ]);

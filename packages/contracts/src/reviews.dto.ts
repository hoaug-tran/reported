...
export type UpdateReviewDecisionDto = z.infer<
  typeof UpdateReviewDecisionSchema
>;
...
export type UpdateAcknowledgementDto = z.infer<
  typeof UpdateAcknowledgementSchema
>;
...
export const ReviewFilterSchema = z.object({
  ...
  status: z
    ...
    .or(z.array(z.nativeEnum(ReviewStatus)))
    .optional(),
